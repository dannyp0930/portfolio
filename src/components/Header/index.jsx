    ...
    <header className="fixed top-0 left-0 z-50 font-bold text-white w-dvw h-header underline-offset-4">
      <nav className="flex items-center justify-between w-full h-full px-5 md:px-12">
        ...
        <ul className="flex items-center gap-5 text-2xl">
          <li><a className="hover:underline" href="#info">
            <span className="hidden md:inline">Info</span>
            <svg className="w-6 h-6 stroke-2 md:hidden stroke-white fill-transparent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
            </svg>
          </a></li>
          <li><a className="hover:underline" href="#skills">
            <span className="hidden md:inline">Skills</span>
            <svg className="w-6 h-6 stroke-2 md:hidden stroke-white fill-transparent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z" />
            </svg>
          </a></li>
          <li><a className="hover:underline" href="#project">
          ...
          <li><a className="hover:underline" href="#career">
