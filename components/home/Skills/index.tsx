...
export default function Skills({ skills }: SkillsProps) {
	...
	// 		title: 'HTML',
	// 		image: htmlSvg,
	// 		content: 'SEO를 위한 시멘틱 태그 사용',
	// 		level: 4,
	// 	},
	// 	{
	// 		title: 'CSS',
	// 		image: css3Svg,
	// 		content: 'Class별 스타일링 선호',
	// 		level: 4,
	// 	},
	// 	{
	// 		title: 'Git',
	// 		image: gitSvg,
	// 		content: '소스코드 버전 관리 및 프로젝트 협업 경험',
	// 		level: 2,
	// 	},
	// 	{
	// 		title: 'Jira',
	// 		image: jiraSvg,
	// 		content: '프로젝트 일정 관리 및 협업 툴 사용',
	// 		level: 3,
	// 	},
	// 	{
	// 		title: 'Python',
	// 		image: pythonSvg,
	// 		content: '기본 파이썬 문법 이해, 라이브러리를 사용한 알고리즘 구현',
	// 		level: 2,
	// 	},
	// 	{
	// 		title: 'JavaScript',
	// 		image: javascriptSvg,
	// 		content:
	// 			'기본 자바스크립트 문법 이해, 자바스크립트 프레임 워크 사용',
	// 		level: 3,
	// 	},
	// 	{
	// 		title: 'TypeScript',
	// 		image: typescriptSvg,
	// 		content: '타입, 인터페이스 사용하여 정적 타입 명시',
	// 		level: 2,
	// 	},
	// 	{
	// 		title: 'Linux',
	// 		image: LinuxSvg,
	// 		content: '리눅스 서버 환경에서의 배포 경험',
	// 		level: 2,
	// 	},
	// 	{
	// 		title: 'Node.js',
	// 		image: nodedotjsSvg,
	// 		content: 'Node.js 서버 배포 경험',
	// 		level: 2,
	// 	},
	// 	{
	// 		title: 'Jenkins',
	// 		image: jenkinsSvg,
	// 		content: 'Jenkins 자동 배포 경험',
	// 		level: 2,
	// 	},
	// 	{
	// 		title: 'Firebase',
	// 		image: firebaseSvg,
	// 		content: 'Firestore 이용한 No SQL 사용',
	// 		level: 1,
	// 	},
	// 	{
	// 		title: 'React',
	// 		image: reactSvg,
	// 		content: 'SPA 서비스 제작 및 업무 경험',
	// 		level: 4,
	// 	},
	// 	{
	// 		title: 'Vue.js',
