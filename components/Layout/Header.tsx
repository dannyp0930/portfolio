...
export default function Header() {
	...
	const navLinkClass = (id: SectionId) =>
		`hover:underline transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-theme focus-visible:rounded ${
			activeSection === id
	...
	return (
		<header className="fixed top-0 left-0 z-50 font-bold text-white w-full h-header underline-offset-4 flex flex-col">
			<nav className="flex items-center justify-between w-[90%] h-3/4 m-auto px-5 md:px-12 bg-theme-sub/80 backdrop-blur-md rounded-full border border-white/10 shadow-lg">
				<Link
				...
				<ul className="flex items-center gap-3 md:gap-5 text-base">
					...
					{session ? (
						isAdmin ? (
							<li>
								<Link
									className="hover:underline text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-theme focus-visible:rounded"
									href="/dashboard"
								>
